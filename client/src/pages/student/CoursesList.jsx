...
function CoursesList() {
  ...
  useEffect(()=>{
    ...
    if(allCourses && allCourses.length>0){
      ...
      input? setFilterdCourse(tempCourses.filter(item=>item.courseTitle.toLowerCase().includes(input.toLowerCase())))  :setFilterdCourse(tempCourses)
    ...
    <>
      ...
      <div className='relative md:px-36 px-8 pt-20 text-left'>
        ...
        <div className='flex md:flex-row flex-col gap-6 items-start justify-between w-ful'>
          ...
          <div>
            ...
            <p className='text-gray-500'>
              ...
              <span className='text-blue-600 curser-pointer' onClick={() => { navigate('/') }}>Home</span> / <span>Course List</span></p>
        ...
        {input && <div className='inline-flex items-center gap-4 px-4 py-2 border mt-3 mb-8 text-gray-600'> 
          ...
          <p>{input}</p>
          <img src={assets.cross_icon} alt="" className='curser-pointer' onClick={()=>{navigate('/course-list')}}/>

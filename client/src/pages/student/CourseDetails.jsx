...
{/* left coloumn */}
    <div className='max-w-xl z-10 text-gray-500'>
      ...
      <h1 className='md:text-course-details-heading-large course-details-heading-small  font-semibold text-gray-800'>{courseData.courseTitle}</h1>
      ...
      {/* review and reating */}
       <div className='flex items-center space-x-2 pt-3 pb-1 text-sm'>
              ...
              <div className='pt=-8 text-gray-800'>
                ...
                <h2 className='text-xl font-semibold'>Course Structue</h2>

                <div className='pt-5'>

                  {courseData.courseContent.map((chapter,index)=> <div key={index}
...
{chapter.chapterContent.map((lecture,i)=>(<li className='flex items-start gap-2 py-1' key={i}>
  ...
  <div className='flex items-center justify-between w-full text-gray-800 text-xs md:text-default'>
    ...
    <div className='max-w-[--max-w-course-card] z-10 shadow-custom-card rounded-t md:rounded-none overflow-hidden bg-white min-w-[300px] sm:min-w-[420px]'>
...
<div className='p-5'>
  ...
  <div className='flex items-center text-sm md:text-default gap-2 md:pt-4 text-gray-500'>

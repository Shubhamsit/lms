  ...
  return (
    <div className="h-screen overflow-scroll flex flex-col items-start justify-between md:pb-0 p-4 pt-8 pb-0">
      <form
        ...
        className="flex flex-col gap-4 max-w-md text-gray-500"
      >
          ...
          <div className="flex md:flex-row flex-col items-center gap-3">
            ...
            <label htmlFor="thumbnailImage" className="flex items-center gap-3">
              <img
                ...
                alt=""
                className="p-3 bg-blue-500 rouded"
              />
              ...
              <div className="flex justify-between items-center p-4 border-b">
                <div className="flex items-center">
                  <img
                    ...
                    alt=""
                    width={14}
                    className={`mr-2 cursor-pointer transitio-all ${
          ...
          {showPopup && (
            <div className="fixed inset-0 flex items-center justify-center bg-gray-800 bg-opacity-50">
              <div className="bg-white text-gray-700 p-4 rounded relative w-full max-w-80">
                <h2 className="text-lg font-semi\ mb-4">Add Lecture</h2>
